...
const GROUPS = [
  ...
  },
  {
    ...
    slots: [
      {
        key: "map",
        label: "지도 사진 (홈 상담 섹션 + 오시는 길)",
        hint: "네이버 지도에서 사무소 위치를 화면 캡처해서 올리세요. 사진을 누르면 '기본정보/문구' 탭에 등록한 네이버 지도 링크로 연결됩니다.",
        opts: {
          kind: "plain",
          maxWidth: 1200,
          recommend:
            "권장 사이즈: 가로 1200px 이상의 가로형 (약 16:9). 사진은 잘리지 않고 원본 비율 그대로 표시됩니다. 지도 주변이 시간이 지나 바뀔 수 있으니 가끔 갱신해 주세요.",
        },
      },
    ],
  },
